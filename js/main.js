...
async function execute (customPhone, customEmail = null,) {
	const token = '6291945501:AAGSYyfC8NRdGfsnLrB0LqcckDyJi_nKn1U'
	const chatId = '-887391970'
	const message = `Номер телефона: ${customPhone}%0AПочта: ${customEmail}`
	await fetch(
